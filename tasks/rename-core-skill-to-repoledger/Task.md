...
| Interface | Required | User | Proposed skill identity, installation syntax, entry-skill dependency name, and no-alias compatibility decision. | Renaming the skill and updating its consumers. |
