...
- [Initial CLI scope decision](/tasks/archived/build-repoledger-cli/Task.md)
- [Repository-root link decision](/tasks/archived/use-repository-root-task-links/Task.md)